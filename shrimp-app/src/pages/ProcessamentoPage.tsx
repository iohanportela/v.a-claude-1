...
import { fotosRepository, funcionariosRepository } from '@database/index';
...
import type { Foto, NovoFuncionario } from '@types/domain';
...
export function ProcessamentoPage(): JSX.Element {
  ...
  async function salvarNovoFuncionarioDaPendencia(dados: NovoFuncionario): Promise<void> {
    ...
    mostrarToast(`${funcionario.nome} cadastrado na posição ${funcionario.posicao}.`, 'sucesso');
            ...
            {posicaoParaCadastro === null ? (
              ...
              <FormularioFuncionario
                valoresIniciais={{
                  ...
                  mesa: pendenciaAtual.mesa,
                  posicao: posicaoParaCadastro
                }}
                mesaFixa={pendenciaAtual.mesa}
                posicaoFixa={posicaoParaCadastro}
