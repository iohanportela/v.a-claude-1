...
import { funcionariosRepository, mesasRepository } from '@database/index';
import type { Funcionario, MapaMesaPosicao } from '@domain/domain';

/** Lista reativa de todas as mesas cadastradas, atualizada automaticamente. */
export function useMesas(): string[] {
  return useLiveQuery(() => mesasRepository.listarNomes(), [], []) ?? [];
}
